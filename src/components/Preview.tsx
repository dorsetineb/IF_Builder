...
const Preview: React.FC<{ gameData: GameData, testSceneId?: string | null, basePath?: string }> = ({ gameData, testSceneId, basePath }) => {
    ...
    const fullHtml = useMemo(() => {
        ...
        const finalCss = (gameCSS + cssOverrides)
            ...
            .replace(/__DICE_BUTTON_COLOR__/g, gameData.gameDiceRollButtonBg || '#3b82f6')
            .replace(/__DICE_BUTTON_TEXT_COLOR__/g, gameData.gameDiceRollButtonTextColor || '#ffffff')
            .replace(/__DICE_BUTTON_HOVER_COLOR__/g, gameData.gameDiceRollButtonHoverColor || '#2563eb')
