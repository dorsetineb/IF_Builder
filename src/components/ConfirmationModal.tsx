...
export const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className={`bg-zinc-900 ${isDanger ? 'border-2 border-red-600 shadow-[0_0_40px_rgba(220,38,38,0.3)]' : 'border-2 border-muted-foreground/20'} rounded-xl p-6 max-w-md w-full shadow-2xl space-y-4 animate-in fade-in zoom-in-95 duration-200`}>
