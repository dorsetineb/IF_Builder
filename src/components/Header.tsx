              ...
              {isPreviewing ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-lg transition-all text-xs shadow-lg shadow-purple-900/20 active:scale-95 border border-purple-500"
                    title="Pré-visualizar Jogo"
                  >
                    <Eye className="w-3.5 h-3.5 mr-2 text-white" /> Pré-visualizar
                  </button>
