...
`.trim();
    ...
    const css =
      finalCss
        ...
        .replace(/__ACTION_BUTTON_HOVER_COLOR__/g, exportData.gameActionButtonHoverColor || '#f0f0f0')
        .replace(/__DICE_BUTTON_COLOR__/g, exportData.gameDiceRollButtonBg || '#3b82f6')
        .replace(/__DICE_BUTTON_TEXT_COLOR__/g, exportData.gameDiceRollButtonTextColor || '#ffffff')
        .replace(/__DICE_BUTTON_HOVER_COLOR__/g, exportData.gameDiceRollButtonHoverColor || '#2563eb')
        .replace(/__SYSTEM_BUTTON_COLOR__/g, exportData.gameSystemButtonColor || 'transparent')
        .replace(/__SYSTEM_BUTTON_TEXT_COLOR__/g, exportData.gameSystemButtonTextColor || exportData.gameTextColor || '#c9d1d9')
        .replace(/__SYSTEM_BUTTON_BORDER_COLOR__/g, exportData.gameSystemButtonBorderColor || (exportData.gameTextColor ? (exportData.gameTextColor + '40') : '#c9d1d940'))
        .replace(/__SYSTEM_BUTTON_HOVER_COLOR__/g, exportData.gameSystemButtonHoverColor || exportData.gameFocusColor || '#58a6ff')
        .replace(/__SYSTEM_BUTTON_HOVER_TEXT_COLOR__/g, exportData.gameSystemButtonHoverTextColor || exportData.gameSystemButtonTextColor || exportData.gameTextColor || '#c9d1d9')
