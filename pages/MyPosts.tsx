        ...
        <div className="p-4 max-w-[1600px] mx-auto font-sans h-[calc(100vh-48px)] overflow-y-auto text-xs">
            ...
            <div className="flex flex-col gap-4 mb-6">
                <div className="flex justify-between items-end">
                    <div>
                        <h1 className="text-xl font-bold text-foreground mb-1">Minhas Postagens</h1>
                        <p className="text-muted-foreground text-xs">Gerencie os tópicos que você criou.</p>
                    </div>

                    <div className="relative w-80">
                        <input
                            type="text"
                            placeholder="Pesquisar nas minhas postagens..."
                            value={searchTerm}
            ...
            <div className="border border-border rounded-lg overflow-hidden bg-card/50">
                ...
                <div className="divide-y divide-border">
                    {loading ? (
                        <div className="p-8 text-center text-muted-foreground text-xs">Carregando suas postagens...</div>
