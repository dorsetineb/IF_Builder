...
- **Sistemas de Jogo Integrados**:
  - **Inventário**: Gestão de objetos e itens coletáveis.
  - **Trackers**: Variáveis numéricas para HP, sanidade, mana ou progresso.
  - **Diário**: Registro automático ou manual das ações do jogador.
- **Estética Customizável**: Suporte a diversos temas de interface (App Themes) e presets para o jogo final.
- **Shader de Dither**: Efeitos visuais retrô dinâmicos integrados via shaders GLSL.
...
- **Noite (Dark)**: O padrão moderno e confortável.
- **Menta (Terminal)**: Inspirado em monitores CRT clássicos.
- **W95**: Nostalgia pura dos sistemas operacionais dos anos 90.
- **Ether**: Estética Zen/Hacker com tons de verde sálvia.
